    ...
    <aside id="sidebar"
        ...
        <div class="flex items-center justify-between p-4 h-16 border-b border-teal-600">
            <div class="flex items-center min-w-[40px]">
                <img src="/logo.png" alt="Techin" class="w-8 h-8" />
                <span
        ...
        <!-- Search Box dengan Animasi Smooth -->
        <div class="px-3 py-4 border-b border-teal-600">
            <div class="relative flex items-center">
                <!-- Ikon search yang selalu visible -->
                <i
                    class="fas fa-search text-teal-300 absolute left-3 transition-all duration-300 
                          lg:left-1/2 lg:-translate-x-1/2 lg:group-hover:left-3 lg:group-hover:translate-x-0"></i>

                <!-- Input field dengan animasi -->
        ...
        <!-- Menu Utama -->
        <nav class="flex-1 flex flex-col px-2 py-4 overflow-y-auto scrollbar">
            <!-- Section Umum -->
            <div class="mb-4">
                <p
                    class="uppercase text-xs text-teal-200 mb-2 pl-1 
                         lg:opacity-0 lg:group-hover:opacity-100 lg:transition-opacity duration-300">
                    Umum
                </p>
                <ul class="space-y-1">
                    <li>
