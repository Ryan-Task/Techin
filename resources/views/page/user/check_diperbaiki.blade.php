...
<div class="border rounded-md p-4 bg-white shadow-sm">
  <div class="flex items-center gap-2 border-b pb-2 mb-3">
    ...
    <div class="w-9 h-9 flex items-center justify-center bg-yellow-100 text-yellow-700 rounded-full">
      <i class="fas fa-wrench text-lg"></i>
    </div>
    <h2 class="font-semibold text-gray-800">Barang Sedang Diperbaiki</h2>
  </div>
  <p class="text-sm text-gray-600">
    Mohon bersabar, barang Anda sedang dalam tahap perbaikan. Informasi akan dikirim melalui WhatsApp maupun notifikasi jika barang sudah selesai.
  </p>
</div>
      ...
      <div class="border rounded-md p-4 bg-white shadow-sm grid md:grid-cols-2 gap-4">
        <div>
          ...
          <p><span class="font-medium">Status:</span> <span class="text-yellow-700">Sedang Diperbaiki Oleh Teknisi</span></p>
          <p><span class="font-medium">Tanggal Update:</span> 19 Juni 2025, 10:45 WIB</p>
